...
function Graph(method, url, options, postData, callback) {
...
exports.get = function(url, params, callback) {
  ...
  return new Graph('GET', url, this.options, callback);
};
...
exports.post = function (url, postData, callback) {
  ...
  return new Graph('POST', url, this.options, postData, callback);
};
