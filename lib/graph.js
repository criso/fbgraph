...
function Graph(method, url,context, postData, callback) {
...
Graph.prototype.cleanUrl = function(url) {
  ...
  if (accessToken && appSecret && url.indexOf('appsecret_proof') === -1) {
...
Graph.prototype.end = function (body) {
  ...
  if(this.context != null){
    this.callback.call(this.context,err, json);
  }else{
...
exports.get = function(url, params, callback) {
  ...
  if(this.context){
    return new Graph('GET', url,this.context ,callback);
  }else{
...
exports.post = function (url, postData, callback) {
  ...
  if(this.context){
    return new Graph('POST', url,this.context ,postData, callback);
  }else{
...
/**
 * Sets the context in which callbacks are called
 *
